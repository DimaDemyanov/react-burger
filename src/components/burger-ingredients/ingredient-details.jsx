...
const CompositionStat = ({type, stat}) => {
    return (
        <div className={`${ingredientsStyles.compositionStat} mr-5 text_color_inactive`}>
...
const IngredientDetails = (props) => {
    return (
        <Modal {...props}>
            <img src={props.ingredient.image_large} className={`ml-4`} alt="ingredient"/>
            ...
            <div className={`${ingredientsStyles.composition} mt-8 mb-15`}>
                <CompositionStat type="Калории, ккал" stat={props.ingredient.calories} />
                <CompositionStat type="Белки, г" stat={props.ingredient.proteins} />
                <CompositionStat type="Жиры, г" stat={props.ingredient.fat} />
                <CompositionStat type="Углеводы, г" stat={props.ingredient.carbohydrates} />
            </div>
        </Modal>
    );
};
